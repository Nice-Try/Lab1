...
Update: Friday Oct 12: Fixed more test bench errors and implemented zero output. We're like 95% sure everything works as intended now. The timing analysis still has not been done.
